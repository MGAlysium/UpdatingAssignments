Public Class frmStateFairApp

    Const price As Double = 12.99

    Private Sub frmStateFairApp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblTicketCost.Text = price.ToString("C") + " per Ticket"
    End Sub
